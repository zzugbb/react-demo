...
class Game extends Component {
  ...
  render() {
    ...
    var pause_start_btn = <button onClick={this._pause.bind(this)} className="pause">暂停</button>;
    if(!this.state.is_runing){
      pause_start_btn =<button onClick={this._start.bind(this)} className="start">开始</button>;
    }
    ...
    return (
      <div className="game">
        ...
        <div className="game-menu">
          <a href=" ">游戏</a>
          <a href=" ">帮助</a>
          <h4 className="score">得分: {this.state.score}</h4>
          {pause_start_btn} 
        ...
        <div className="game-div">
          ...
          <div className="game-info"> 
            <div className="direction-pos">
              <div className="direction">
                <img src={leftImg} alt="" className="leftImg" onClick={this.handleClickLeft.bind(this)}/>
                <img src={rightImg} alt="" className="rightImg" onClick={this.handleClickRight.bind(this)}/>
                <img src={upImg} alt="" className="upImg" onClick={this.handleClickUp.bind(this)}/>
                <img src={downImg} alt="" className="downImg" onClick={this.handleClickDown.bind(this)}/>
              </div> 
            </div>
          </div>    
        </div>
